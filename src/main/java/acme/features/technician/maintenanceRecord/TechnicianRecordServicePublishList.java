...
@GuiService
public class TechnicianRecordServicePublishList extends AbstractGuiService<Technician, MaintanenceRecord> {
	...
	public void load() {
		...
		record = this.repository.getPublishedMaintanenceRecords(technicianId);
