...
<acme:list>
	...
	<acme:list-column code="administrator.service.list.label.picture" path="picture" width="20%"/>
	<acme:list-column code="administrator.service.list.label.averageDwellTime"  path="averageDwellTime" width="10%"/>
